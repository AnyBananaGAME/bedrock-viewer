module.exports =
{
  ...
  'bedrock': {
    ...
    '1.20.61': {
      ...
      get biomes () { return require("./minecraft-data/data/bedrock/1.20.61/biomes.json") },
      get entities () { return require("./minecraft-data/data/bedrock/1.20.61/entities.json") },
      get items () { return require("./minecraft-data/data/bedrock/1.20.61/items.json") },
      get recipes () { return require("./minecraft-data/data/bedrock/1.20.61/recipes.json") },
      get instruments () { return require("./minecraft-data/data/bedrock/1.17.0/instruments.json") },
      get materials () { return require("./minecraft-data/data/pc/1.17/materials.json") },
      get enchantments () { return require("./minecraft-data/data/bedrock/1.19.1/enchantments.json") },
      get effects () { return require("./minecraft-data/data/pc/1.17/effects.json") },
